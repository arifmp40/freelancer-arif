$(document).ready(function () {
  ...
  typeAnim(".welcome ", 0, false, "welcome,");
  typeAnim(".arifText ", 400, false, "i am <span class = 'arif'>arif</span>");
  typeAnim(".webDesign ", 900, false, "web designer");
  typeAnim(
    ".headText ",
    1300,
    false,
    "first of all, i am an intermediate developer. and i hope you'll have a better idea about my skills from my portfolio."
  );
